...
const PLANS = [
  ...
  },
  {
    ...
    price: '$49',
    period: '/mo',
    description: 'For serious bettors who want the full edge.',
  ...
  },
  {
    ...
    price: '$149',
    period: '/mo',
    description: 'Institutional-grade intelligence at your fingertips.',
    color: 'border-amber-500/30',
    badge: 'Elite',
    features: [
      'Everything in Pro',
      'Walk-forward backtesting',
      'Ensemble ML model signals',
