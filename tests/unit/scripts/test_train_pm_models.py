"""Contract stub tests for train_pm_models script — Phase 9 plan 01.

The script does not exist yet (implemented in plan 04/05).
...
# ---------------------------------------------------------------------------
# xfail RED stubs — document the train_pm_models contract
# ---------------------------------------------------------------------------

@pytest.mark.xfail(reason="plan 04/05 implementation pending — script not yet created")
